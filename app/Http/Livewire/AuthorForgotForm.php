...
class AuthorForgotForm extends Component
{
    ...
    public function ForgotHandler()
    {
        ...
        $body_message = '<br>';
        $body_message .= "We have received a request to reset the password for <b>BLOGNJ</b> account associated with " . $this->email . ". <br> You can reset your password by clicking the button below.";
        $body_message .= '<br>';
