...
class AuthorResetForm extends Component
{
    ...
    public function ResetHandler()
    {
        ...
        if (!$check_token) {
            ...
            User::where('email', $this->email)->update(['password' => Hash::make($this->new_password)]);
            ...
            session()->flash(
                'success',
                'Your password has been updated successfully. Login with your email ' .
                '<b>' . $this->email . '</b> and your new password.'
            );
