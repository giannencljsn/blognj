...
class Categories extends Component
{
    ...
    public function showNavigation()
    {
        ...
        return view('front.layouts.inc.header', compact('categories'));
    }

    public function showSubCategoryNavigation()
    {
        $subcategories = SubCategory::all(); // Fetch all categories
        return view('front.layouts.inc.header', compact('subcategories'));
    }
}
