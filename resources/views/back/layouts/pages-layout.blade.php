...
<body>
        ...
        <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark">
                    <a href=".">
                        <img src="./back/static/logo.svg" width="110" height="32" alt="Tabler"
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm"
                                style="background-image: url(./back/static/avatars/000m.jpg)"></span>
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item" href="./back/alerts.html">
                                            Add New Post
                                        </a>
    ...
    <scrip src="./back/dist/js/demo.min.js?1692870487" defer>
        </script>
        @stack('scripts')
        @livewireScripts
