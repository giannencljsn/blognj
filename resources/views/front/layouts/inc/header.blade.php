                ...
                <ul class="navbar-nav mt-3 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">App dev.</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url('category/flutter') }}">Flutter</a>
                            <a class="dropdown-item" href="{{ url('category/kotlin') }}">Kotlin</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">Web dev.</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url('category/codeigniter') }}">CodeIgniter</a>
                            <a class="dropdown-item" href="{{ url('category/cakephp') }}">CakePHP</a>
                            <a class="dropdown-item" href="{{ url('category/laravel') }}">Laravel</a>
                        </div>
                    </li>
