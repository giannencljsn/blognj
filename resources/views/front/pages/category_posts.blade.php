...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Welcome to BloGNJ')
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <h2 class="widget-title my-3">BloGNJ</h2>

                            <p class="mb-3 pb-2">Hello I'm currently a
                                <?php $year = date("Y") - 2001;
echo $year ?> year old Software Developer, with a passion for science and
                                technology. So this blog is all about my passion. Enjoy!
                            </p> <a href="about.html" class="btn btn-sm btn-outline-primary">Know
                                More</a>
                        </div>
                    </div>
                </div>
