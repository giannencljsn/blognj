    ...
    <div class="card-body">
        <div id="carousel-indicators" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                ...
                <button type="button" data-bs-target="#carousel-indicators" data-bs-slide-to="1" class="active"
            ...
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="./front/images/carousel/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg">
                </div>
                <div class="carousel-item active">
                    <img class="d-block w-100" alt="" src="./front/images/carousel/young-woman-working-in-a-cafe.jpg">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="./front/images/carousel/everything-you-need-to-work-from-your-bed.jpg">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="./front/images/carousel/young-entrepreneur-working-from-a-modern-cafe.jpg">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt=""
                        src="./front/images/carousel/finances-us-dollars-and-bitcoins-currency-money-2.jpg">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <article class="card article-card">
                        ...
                        <div class="card-body px-0 pb-1">
                            ...
                            <div class="content"> <a class="read-more-btn"
                                    href="{{ route('read_post', single_latest_post()->post_slug) }}">Read Full Article</a>
                            </div>
                        </div>
                    </article>
                @endif
