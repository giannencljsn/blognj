<div>
    @php
        $theme = request('theme', 'light'); // Default to 'light' if no theme is set
        $logo = $theme === 'dark'
            ? url("back/dist/img/logo-favicon/" . \App\Models\Setting::find(1)->logo_dark)
    ...
    <header class="navbar navbar-expand-md navbar-light d-print-none sticky-top">
        <div class="container-xl">
            ...
            <h1 class="navbar-brand d-none-navbar-horizontal pe-0 pe-md-3">
                <a href="{{ route('home') }}">
                    <img id="navbar-logo" src="{{ $logo }}" width="110" height="32" alt="Tabler"
...
<script>
    ...
    const darkModeButton = document.getElementById('enable-dark-mode');
    const lightModeButton = document.getElementById('enable-light-mode');

    darkModeButton.addEventListener('click', () => {
        logo.src = "{{ \App\Models\Setting::find(1)->logo_dark }}";
    });

    lightModeButton.addEventListener('click', () => {
        logo.src = "{{ \App\Models\Setting::find(1)->blog_logo }}";
    });
</script>